...
class fancourier extends \Opencart\System\Engine\Model {
    ...
    public function connect($user_id, $rewrite = false) {
        ...
        $storage = $this->model_integration_delivery_delivery->getStorage($user_id, 'fancourier');
    ...
    public function getAllCountries() {
        if (!isset($this->session->data['fancourier']['username']$this->session->data['fancourier']['username']) or !isset($this->session->data['fancourier']['password'])) {
            return false;
        }
