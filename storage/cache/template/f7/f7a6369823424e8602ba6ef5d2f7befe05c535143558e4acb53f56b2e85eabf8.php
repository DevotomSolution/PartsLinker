...
/* view/template/admin/vehicle_transmission.twig */
class __TwigTemplate_d71c09970ba0f6a6b9304eebbc2c0c95ed6828a380ce1b7580d20b1432656b3b extends Template
{
    private $source;
    private $macros = [];
...
\t  ";
        // line 24
        $context['_parent'] = $context;
        $context['_seq'] = twig_ensure_traversable(($context["vehicle_transmissions"] ?? null));
        foreach ($context['_seq'] as $context["_key"] => $context["transmission"]) {
            // line 25
            echo "\t  <div class=\"chip me-0\">";
            echo twig_get_attribute($this->env, $this->source, $context["transmission"], "text", [], "any", false, false, false, 25);
            echo "<i id=\"";
            echo twig_get_attribute($this->env, $this->source, $context["transmission"], "vehicle_transmission_id", [], "any", false, false, false, 25);
...
\turl: '";
        // line 41
        echo ($context["server"] ?? null);
        echo "index.php?route=admin/vehicle/transmission.add&user_token=";
...
\t  url: '";
        // line 61
        echo ($context["server"] ?? null);
        echo "index.php?route=admin/vehicle/transmission.remove&user_token=";
        echo ($context["user_token"] ?? null);
        echo "&transmission_id=' + encodeURIComponent(e.target.id),
\t});
\t
...
";
    ...
    {
        return "view/template/admin/vehicle_transmission.twig";
    }
    ...
    {
        return new Source("", "view/template/admin/vehicle_transmission.twig", "/var/www/vhosts/partsmanager.it/httpdocs/view/template/admin/vehicle_transmission.twig");
    }
}
